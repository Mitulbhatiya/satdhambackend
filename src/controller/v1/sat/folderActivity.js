...
const getFolder = async (req, res, next) => {
    try {
        ...
        if (qyear === undefined && qmonth === undefined) {
            ...
            if (qyear && qmonth) {
                console.log(qyear, qmonth, qlocation);
                folders = await Folder.find({ year: qyear, month: qmonth, location: qlocation });
                console.log("aa", folders);
            } else if (qyear) {
                console.log("bb");

                folders = await Folder.find({ year: qyear, location: qlocation });
            } else if (qmonth) {
                console.log("cc");

                folders = await Folder.find({ month: qmonth, location: qlocation });
            } else {
